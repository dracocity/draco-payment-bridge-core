...
type nowPaymentsCreateInvoicePaymentRequest struct {
...
type nowPaymentsCreateInvoicePaymentPayload struct {
}

type nowPaymentsCreateInvoicePaymentResponse struct {

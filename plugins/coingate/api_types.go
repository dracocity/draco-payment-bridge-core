...
type createOrderRequest struct {
	...
	Shopper         *struct {
		...
		} `json:"company_details,omitempty"` // Company details must be provided when the shopper type is 'business'.
	} `json:"shopper,omitempty"` // Optional object to enhance the shopper’s experience and prefill the Travel Rule form on the checkout page. Learn more about the Travel Rule. All fields are optional.
}
